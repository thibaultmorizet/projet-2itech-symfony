 ...
 */
final class Version20220623080932 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movie_entity (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) DEFAULT NULL, year VARCHAR(30) DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
